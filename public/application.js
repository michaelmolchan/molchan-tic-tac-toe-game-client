...
var authApi = __webpack_require__(1);
...
var winCombos = function winCombos() {
  return [[gameboard[0], gameboard[1], gameboard[2]], [gameboard[3], gameboard[4], gameboard[5]], [gameboard[6], gameboard[7], gameboard[8]], [gameboard[0], gameboard[3], gameboard[6]], [gameboard[1], gameboard[4], gameboard[7]], [gameboard[2], gameboard[5], gameboard[8]], [gameboard[0], gameboard[4], gameboard[8]], [gameboard[2], gameboard[4], gameboard[6]]];
};
...
var onCreateNewGame = function onCreateNewGame(event) {
  ...
  authApi.createNewGame(data).then(authUi.createNewGameSuccess).catch(authUi.createNewGameError);
};

var onGetGameInfo = function onGetGameInfo(event) {
  event.preventDefault();
  var info = getFormFields(event.target);
  authApi.getGameInfo(info).then(authUi.getGameInfoSuccess).catch(authUi.getGameInfoError);
};
...
var createNewGameSuccess = function createNewGameSuccess(createNewGameResponse) {
...
var createNewGameError = function createNewGameError(_createNewGameError) {
  // console.log('something went wrong. Here\'s your error: ', createNewGameError)
};

var getGameInfoSuccess = function getGameInfoSuccess(_getGameInfoSuccess) {
  $('#game-info').show();
  $('#game-info').html('Player One ID: ' + _getGameInfoSuccess.game.player_x.id + '<br>Game ID: ' + _getGameInfoSuccess.game.id + '<br>Signed In As: ' + _getGameInfoSuccess.game.player_x.email);
};

var getGameInfoError = function getGameInfoError(_getGameInfoError) {
...
module.exports = {
  ...
  createNewGameError: createNewGameError,
  getGameInfoSuccess: getGameInfoSuccess,
  getGameInfoError: getGameInfoError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
